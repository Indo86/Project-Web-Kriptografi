...
<div class="card shadow-sm bg-dark">
  ...
  <div class="row">
    ...
    <div class="col-4">
      ...
      <h3 class="text-light text-center">Form Edit Data Agen</h3>
...
$queryTampilData = "SELECT * FROM agen WHERE id = '$id_agen'";
...
<div class="container mt-2 mb-3">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="nama_asli" name="nama_asli" value="<?= openssl_decrypt( $datum["nama_asli"],$chiperAlgo,$keyAes, $options, $ivAes)?>">
    </div>
  </div>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="penempatan" name="penempatan" value="<?= openssl_decrypt( $datum["penempatan"],$chiperAlgo,$keyAes, $options, $ivAes)?>">
    </div>
  </div>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="unik" name="unik" value="<?= openssl_decrypt( $datum["unik"],$chiperAlgo,$keyAes, $options, $ivAes)?>">
    </div>
  </div>
