        ...
        <div class=" card shadow-2-strong" style="border-radius: 1rem;">
          <div class="card-header">
            <ul class="nav nav-pills card-header-pills">
              <li class="nav-item">
                <a class="nav-link" href="loginAgen.php">Agen</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" href="#">Perwira</a>
              </li>
            </ul>
          </div>
          <div class="card-body p-5">
            ...
            <button class="btn login btn-primary btn-lg btn-block d-grip col-12 mx-auto text-center-round" name="loginPerwira">Login</button>
